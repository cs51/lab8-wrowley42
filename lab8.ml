...
......................................................................*)
  ...
  let remove_listener (evt : 'a event) (i : id) : unit =
    let rec helper l a i =
        match l with
        | [] -> ()
        | h :: [] -> if h.id == i then evt := a
                     else ()
        | h :: t  -> if h.id == i then evt := a @ t
                     else helper (t) (a @ [h]) i in
    helper !evt [] i
...
let el1 = WEvent.add_listener newswire fakeNewsNetwork;;
let el2 = WEvent.add_listener newswire buzzFake;;
(* .. *)
...
......................................................................*)
WEvent.remove_listener newswire el1;;
WEvent.remove_listener newswire el2;;
(* .. *)
